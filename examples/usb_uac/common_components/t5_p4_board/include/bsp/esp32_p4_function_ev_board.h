...
/**
 * @file
 * @brief ESP BSP: LilyGo T5-P4 E-Paper board
 */
...
/* Audio */
#define BSP_I2S_SCLK            (GPIO_NUM_42)
#define BSP_I2S_MCLK            (GPIO_NUM_43)
#define BSP_I2S_LCLK            (GPIO_NUM_40)
#define BSP_I2S_DOUT            (GPIO_NUM_39)   // To Codec ES8311
#define BSP_I2S_DSIN            (GPIO_NUM_41)   // From Codec ES8311
/* Audio PA is controlled by PCA9535 IO expander on T5-P4 */
#define BSP_POWER_AMP_IO        (-1)
#define BSP_PCA9535_I2C_ADDR    (0x20)
#define BSP_PCA9535_AUDIO_SHDN  (5)
...
#define BSP_SD_MOSI             (GPIO_NUM_46)
#define BSP_SD_MISO             (GPIO_NUM_44)
#define BSP_SD_CLK              (GPIO_NUM_45)
#define BSP_SD_CS               (GPIO_NUM_47)
#endif
