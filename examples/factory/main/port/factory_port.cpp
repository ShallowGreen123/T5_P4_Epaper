...
static const factory_page_info_t kPageInfo[] = {
    ...
    {FACTORY_PAGE_WIFI, "WiFi", "Hosted WiFi scan and connection page for the onboard ESP32-C6.", "This page boots the ESP32-C6 through t5_p4_board, runs one-shot WiFi scans through esp_hosted/esp_wifi_remote, and can connect to a selected AP.", "LIVE_WIFI"},
    ...
    {FACTORY_PAGE_ICM20948, "ICM20948", "Manual 9-axis IMU sampling over the shared board I2C bus.", "This page probes the sensor only when asked, then renders one accelerometer, gyroscope, magnetometer, and temperature sample on the e-paper display.", "LIVE_IMU"},
    {FACTORY_PAGE_USB_OTG, "USB OTG", "USB Host and Device enumeration test.", "Host mode safely enables BQ25896 VBUS power and enumerates attached peripherals. Device mode keeps OTG boost off and verifies that an external USB Host enumerates the factory HID interface.", "LIVE_USB_OTG"},
